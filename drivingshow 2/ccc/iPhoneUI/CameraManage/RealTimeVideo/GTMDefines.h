...
#define _GTMCompileAsseryjcmbolInner(line, msg) _GTMCOMPILEASSERT ## line ## __ ## msg
#define _GTMCompileAsseryjcmbol(line, msg) _GTMCompileAsseryjcmbolInner(line, msg)
#define _GTMCompileAssert(test, msg) \
typedef char _GTMCompileAsseryjcmbol(__LINE__, msg) [ ((test) ? 1 : -1) ]
