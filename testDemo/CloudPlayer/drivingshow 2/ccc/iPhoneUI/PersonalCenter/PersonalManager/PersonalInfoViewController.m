...
- (void)upLoadIconUrl:(NSURL *)imageUrl{
    ...
    //配置亚马逊参数
    [self s3ConfigParams];
    NSString *secretUid = [kUid sha1];
//    NSString *fileKey = [NSString stringWithFormat:@"user_photo/%@.png",[secretUid uppercaseString]];
    NSString *fileKey = [NSString stringWithFormat:@"user_photo/%@.png",[NSString stringWithFormat:@"%@",identifierForVendor]];
...
- (UIImage *)downLoadIconImage{
    ...
    NSString *secretUid = [kUid sha1];
    NSString *fileKey = [NSString stringWithFormat:@"user_photo/%@.png",identifierForVendor];
...
- (void)writeToDiscoveryServer{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"http://112.124.22.101:8190/user/postUserPhoto?uid=%@",identifierForVendor];
...
//        if ([str0 isEqualToString:@"1002"]) {
//            [self.hud hide:YES];
//
//            self.alertPersionInfo.message = @"设置成功";
//            self.alertPersionInfo.title = @"✅";
//            [self.alertPersionInfo show];
//            
//        }else{
//            HWLog(@"===================");
//            self.alertPersionInfo.message = @"设置失败";
//            self.alertPersionInfo.title = @"❌";
//            [self.alertPersionInfo show];
//        }
    }];
