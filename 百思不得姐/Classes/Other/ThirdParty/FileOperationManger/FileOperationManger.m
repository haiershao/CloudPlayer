...
#import "FileOperationManger.h"
#import "NSString+Hash.h"
#define FILE_PROJECT_NAME @"videos"

static FileOperationManger * manager = nil;

@implementation FileOperationManger
+ (id)defaultManager
{
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        manager = [[FileOperationManger alloc] init];
    });
