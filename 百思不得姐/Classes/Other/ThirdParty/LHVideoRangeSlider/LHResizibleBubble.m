...
- (void)drawRect:(CGRect)rect
{
    ...
    //// Color Declarations
    UIColor* bubbleGradientTop = self.bubbleColor;
    UIColor* bubbleGradientBottom = self.bubbleColor;
    UIColor* bubbleHighlightColor = self.bubbleColor;
    UIColor* bubbleStrokeColor = self.bubbleColor;
