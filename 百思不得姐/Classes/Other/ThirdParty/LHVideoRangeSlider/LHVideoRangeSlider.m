...
- (void)setSliderLeftColor:(UIColor *)sliderLeftColor{

    _sliderLeftColor = sliderLeftColor;
    _leftThumb.sliderLeftColor = sliderLeftColor;
}

- (void)setSliderRightColor:(UIColor *)sliderRightColor{
    
    _sliderLeftColor = sliderRightColor;
...
+ (void)requestThumbnailImagesAtTimesMoviePlayer:(MPMoviePlayerController *)rightMoviePlayer rightPosition:(CGFloat)rightPosition{
    ...
    [rightMoviePlayer requestThumbnailImagesAtTimes:[NSArray arrayWithObject:[NSNumber numberWithDouble:rightPosition]] timeOption:MPMovieTimeOptionExact];
}
